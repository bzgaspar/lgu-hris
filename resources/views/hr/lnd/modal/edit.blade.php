...
<button type="button" class="btn btn-outline-warning" data-bs-toggle="modal" data-bs-target="#edit-form-{{ $item->id }}">
        ...
        <div class="modal-content">
            <form action="{{ route('hr.surveyForm.update', $item->id) }}" method="post">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-outline-danger" data-bs-dismiss="modal">Cance</button>
