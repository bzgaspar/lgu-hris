    ...
    <div class="row">
        ...
        <div class="row">
            ...
            <div class="col">
                <div class="form-floating">
                    <input type="text" min="0" max="100" step="any" class="form-control"
                        name="oral_exam" id="oral_exam" aria-describedby="oral_exam" placeholder="Oral Exam Rating"
        ...
        <div class="row">
            <div class="col">
                <div class="form-floating">
                    <input type="text" min="0" max="100" step="any" class="form-control"
                        name="performance" id="performance" aria-describedby="performance" placeholder="Performance"
