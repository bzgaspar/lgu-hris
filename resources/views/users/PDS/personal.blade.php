...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col text-end">
            <a href="{{ route('users.pds.family.index') }}" class="btn btn-outline-success "><i
                    class="fa-solid fa-chevron-right me-2"></i>Family Background</a>
        </div>
    </div>
    <hr>
    <div class="row d-flex justify-content-center">
        <div class="col col-md-6">
            ...
            <div class="tab">
                ...
                <div class="form-floating mb-1">
                    <input type="text" class="form-control text-uppercase" name="weight" id="weight"
                        placeholder=""
            ...
            <div class="row">
                ...
                <div class="col text-end">
                    <button class="btn btn-outline-success" type="button" id="nextBtn"
