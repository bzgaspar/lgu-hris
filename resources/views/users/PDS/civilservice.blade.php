...
@section('content')
    ...
    <div class="row">
        <div class="col text-start">
            <a href="{{ route('users.pds.educational.index') }}" class="btn btn-outline-success ">Educational Background<i
        ...
        <div class="col text-end">
            <a href="{{ route('users.pds.workexperience.index') }}" class="btn btn-outline-success "><i
                    class="fa-solid fa-chevron-right me-2"></i>Work Experience</a>
        </div>
    </div>
    <hr>
    ...
    <hr>
    {{-- <civil_service-component></civil_service-component> --}}
    <div class="row justify-content-center">
                            ...
                            <td>
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    ...
                                    <form action="{{ route('users.pds.civilservice.destroy', $civil->id) }}"
                                        ...
                                        @method('DELETE')
                                        <button type="submit"
                                            class="btn btn-danger btn-sm text-white rounded-0 rounded-end text-white"
