    ...
    <div class="row d-flex justify-content-center rounded">
        <div class="col col-md-6">
            ...
            <form action="{{ route('users.pds.familyC.store') }}" method="POST">
                ...
                <button class="btn btn-outline-success float-end" type="submit">Add</button>
            </form>
        </div>
    </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="{{ route('users.pds.familyC.destroy', $fam->id) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="btn text-white btn-danger btn-sm text-white" onclick="return confirm('Are you sure?')" ><i
