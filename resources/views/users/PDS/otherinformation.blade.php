...
@section('content')
    ...
    <div class="row justify-content-center">
        <div class="col-12 col-md-8">
            ...
            <div class="form-floating mb-1">
                <input type="text" class="form-control text-uppercase" name="Omemship" id="Omemship" placeholder="Membership in Association"
                    @if ($edit_other) value="{{ $edit_other->Omemship }}"
                            @else
                            value="{{ old('Omemship') }}" @endif>
                <label for="Omemship" class="small">Membership in Association</label>
                @error('Omemship')
                    <p class="text-danger">{{ $message }}</p>
                @enderror
            </div>
            ...
            <table class="table table-hover table-striped smnall table-sm">
                <thead>
                    <tr class="table-light">
                        ...
                        <th class="numeric" width="30%">Membership in Association</th>
                        <th class="numeric"></th>
                    </tr>
                </thead>
