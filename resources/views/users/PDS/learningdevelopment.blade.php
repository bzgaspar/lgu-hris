...
@section('content')
    ...
    <div class="row">
        <div class="col text-start">
            <a href="{{ route('users.pds.voluntarywork.index') }}" class="btn btn-outline-success ">Voluntary Work<i class="fa-solid fa-chevron-left ms-2"></i></a>
        </div>
        <div class="col text-center">
            <strong>Go to</strong>
        </div>
        <div class="col text-end">
            <a href="{{ route('users.pds.otherinformation.index') }}" class="btn btn-outline-success "><i class="fa-solid fa-chevron-right me-2"></i>Other Information</a>
        </div>
    </div>
    <hr>
    <div class="row justify-content-center">
        <div class="col-12 col-md-8">
            ...
            <div class="row">
                <div class="col-12 col-md">
                    <div class="form-floating mb-1">
                        <input type="number" class="form-control text-uppercase" name="LDnumhour" id="LDnumhour" step="any"
                            placeholder=""
