...
@section('content')
    ...
    <div class="row">
        <div class="col text-start">
            <a href="{{ route('users.pds.family.index') }}" class="btn btn-outline-success ">Family Background<i class="fa-solid fa-chevron-left ms-2"></i></a>
        </div>
        <div class="col text-center">
            <strong>Go to</strong>
        </div>
        <div class="col text-end">
            <a href="{{ route('users.pds.civilservice.index') }}" class="btn btn-outline-success "><i class="fa-solid fa-chevron-right me-2"></i>Civil Service</a>
        </div>
    </div>
    <hr>
            ...
            @if ($edit_educ)
                ...
                @else
                    <form action="{{ route('users.pds.educational.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
            @endif
            <div class="form-floating mb-1 small">
                            ...
                            <td>
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    <a href="{{ route('users.pds.educational.edit', $educ->id) }}"
                                        class="btn btn-warning btn-sm  text-white"><i class="fa fa-pencil"
