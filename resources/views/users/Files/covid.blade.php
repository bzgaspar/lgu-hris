        ...
        <div class="row justify-content-center mt-3">
            ...
            <div class="col-12 col-md-10 mx-auto">
                ...
                <div class="row mb-5">
                    <div class="col">
                        @if ($covid)
                            <a class="btn btn-outline-success" href="/storage/Vcard/{{ $covid->photo }}" target="_blank"><i class="fa-solid fa-eye me-2"></i>View Vaccination Card</a>
                        @endif
                    </div>
                </div>
                <button type="submit" class="btn btn-outline-success w-100 "><i class="fa-solid fa-save me-1"></i>Save</button>
                </form>
            </div>
        </div>
    </div>
