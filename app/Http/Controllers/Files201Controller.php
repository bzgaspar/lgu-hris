...
class Files201Controller extends Controller
{
    ...
    public function index()
    {
        ...
        return view('users.files.201')->with('files_201', $files_201)->with('files_201_edit', null);
    }
    ...
    public function edit($id)
    {
        ...
        $files_201 = $this->files_201->where('user_id', Auth::user()->id)->get();
        return view('users.files.201')->with('files_201', $files_201)->with('files_201_edit', $data);
    }
